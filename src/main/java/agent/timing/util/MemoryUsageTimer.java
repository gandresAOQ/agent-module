...
public class MemoryUsageTimer {
    ...
    public static void end(String threadName, long usedMemoryBefore, String className, String method, String application, String platform) {
        ...
        EXECUTOR.submit(() -> MemoryUsageTimer.logMemoryUsage(className, method, Double.valueOf(usedMemoryAfter), application, platform));
    }

    private static void logMemoryUsage(String className, String methodName, Double value, String application, String platform) {
        try {
            Map<String, String> data = new HashMap<>();
            data.put("methodName", methodName);
            data.put("className", className);
            data.put("fullName", className + "." + methodName);
            MongoReporter.report(data, "memory", value, application, platform);
        } catch (Exception e) {
